...
public class SwingUi{
	...
	public SwingUi(){
		...
		while(true){
			...
			for(int i = 0; i < game.getPlayerHand().length; i++){
				pHand[i] = new JLabel(getIconVar(game.getPlayerHand()[i].print()));
				dHand[i] = new JLabel(getIconVar(game.getDealerHand()[i].print()));
			}
	...
	private ImageIcon getIconVar(String cardVal){
		switch(cardVal){
			case "sA": return s1;
			case "s2": return s2;
			case "s3": return s3;
